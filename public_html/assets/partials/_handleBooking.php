<?php 
    ...
    if(!$id_customer_exists)
    {
        ...
        $sql = "INSERT INTO `customers` (`customer_name`, `customer_phone`, `customer_created`,`amphor`) VALUES ('$customer_name', '$customer_phone', current_timestamp(),'$amphor');";
    ...
    {
        // Route is unique, proceed
        $sql = "INSERT INTO `bookings` (`customer_id`, `route_id`, `customer_route`, `booked_amount`, `booked_seat`, `booking_created`,`note`) VALUES ('$customer_id', '$route_id','$customer_route', '$booked_amount', '$customer_seat', current_timestamp(),'$note' );";
        echo $sql;
