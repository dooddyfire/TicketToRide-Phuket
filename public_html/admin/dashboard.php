...
<body>
    ...
    ?>
            ...
            <section id="dashboard">
                ...
                <div id="status">
                    <div id="Booking" class="info-box status-item">
                        ...
                        <a href="./booking.php">ดูเพิ่มเติม <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Bus" class="info-box status-item">
                        ...
                        <a href="./bus.php">ดูเพิ่มเติม <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Route" class="info-box status-item">
                        <div class="heading">
                            <h5>เส้นทางการเดินรถ</h5>
                            <div class="info">
                                <i class="fas fa-road"></i>
                            </div>
                        </div>
                        <div class="info-content">
                            <p>เส้นทางการเดินรถทั้งหมด</p>
                            <p class="num" data-target="<?php 
                        ...
                        <a href="./route.php">ดูเพิ่มเติม <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Seat" class="info-box status-item">
                        ...
                        <a href="./seat.php">ดูเพิ่มเติม <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <!-- <h3>User</h3> -->
                <?php if($role == "admin"){  ?>
                ...
                <div id="user">
                    <div id="Customer" class="info-box user-item">
                        ...
                        <?php if($role=="admin"){ ?>
                        <a href="./customer.php">ดูเพิ่มเติม <i class="fas fa-arrow-right"></i></a>
                        <?php }else{ 
                         echo '<a href="#">View More <i class="fas fa-arrow-right"></i></a>';   
                        }?>
            ...
            <?php } ?>
                <footer>
                    <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> Dashboard
                        </p>
                </footer>
        </div>
    </main>
