            ...
            <?php }
                ...
                <section id="route">
                    ...
                    <?php if($role == "admin"){ ?>
                        ...
                        <div>
                            <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">เพิ่มรายละเอียดเส้นทางเดินรถ<i class="fas fa-plus"></i></button>
                        </div>
                        <?php } ?>
            ...
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">เพิ่มเส้นทางเดินรถ</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                    <label for="viaCities" class="form-label">เส้นทางเดินรถ (เมืองต้นทาง,เมืองปลายทาง)</label>
                                <input type="text" class="form-control" id="viaCities" name="viaCities" placeholder="ชุมพร,ประจวบ" required>
                                <span id="error">
                            ...
                            <div class="mb-3">
                                <label for="busno" class="form-label">รหัสรถตู้</label>
                            ...
                            <div class="mb-3">
                                <label for="stepCost" class="form-label">ราคา</label>
                                <input type="number" class="form-control" id="stepCost" name="stepCost" required>
                            </div>
                            <div class="mb-3">
                                <label for="date" class="form-label">วันเดินทาง</label>
                            ...
                            <div class="mb-3">
                                <label for="time" class="form-label">เวลาเดินทาง</label>
