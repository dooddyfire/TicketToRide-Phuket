...
<?php
        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                $booking_exists = false; // ไม่เช็ค route ซ้ำ จองได้เรื่อยๆ
                $booking_added = false;
                ...
                if($booking_added)
                {
                    ...
                    <strong>เกิดข้อผิดพลาด!</strong> ไม่สามารถจองที่นั่งซ้ำได้ 
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>'.$test;
                }
            }
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">ไม่พบการจอง!!</h1>
                        <p class="fw-light">มาจองเป็นคนแรกกันเถอะ!</p>
                        <hr>
            ...
            <section id="booking">
                ...
                <div id="booking-results">
                    <div>
                        ...
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">จองตั๋ว<i class="fas fa-plus"></i></button>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    echo $customer_idx; // customer_idx คือ id ที่มาจาก database ให้ใช้ตัวนี้เวลาโชว์
                                ?>
                            </td>
                            <td>
                                <?php 
    ...
    <div class="modal fade" id="addPNR" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">ค้นหาตั๋ว</h5>
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cid" class="form-label">กรอกเลข PNR ของคุณ</label>
                            ...
                            <button type="submit" class="btn btn-success" name="submit">ค้นหา</button>
                        </form>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">ทำการจอง</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                                    <input type="text" class="form-control searchInput" value="CUST" placeholder='CUST-XXXXXXX' id="cid" name="cid" oninvalid="this.setCustomValidity('กรุณากรอก รหัสลูกค้า ของคุณ')" required>
                                    <div class="sugg">
                            ...
                            <div class="mb-3">
                                <label for="cname" class="form-label">ชื่อ</label>
                                <input type="text" class="form-control" id="cname" name="cname" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="cphone" class="form-label">เบอร์ติดต่อ</label>
                                <input type="tel" class="form-control" id="cphone" name="cphone" readonly>
                            </div>

                            <div class="mb-3">
                            <label for="birthdaytime">วันที่เดินทาง</label>
                            <input type="date" id="godate" name="godate">

                            </div>

                            <div class="mb-3">
                                <label for="routeSearch" class="form-label">เส้นทางเดินรถ</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                                    <input type="text" class="form-control searchInput" id="routeSearch" name="routeSearch" placeholder="ชุมพร,ประจวบ" value="ชุมพร" required>
                                    <div class="sugg">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="sourceSearch" class="form-label">สถานีต้นทาง</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="mb-3">
                                <label for="destinationSearch" class="form-label">สถานีปลายทาง</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="mb-3">
                                <label for="destinationSearch" class="form-label">อำเภอที่จะลง</label>
                                <!-- Search Functionality -->
                                <select name="amphor" id="amphor" class="form-control">
                                    <option value="ท่าแซะ">ท่าแซะ</option>
                                    <option value="ปะทิว">ปะทิว</option>
                                    <option value="บางสะพาน">บางสะพาน</option>
                                    <option value="บางสะพานน้อย">บางสะพานน้อย</option>
                                    <option value="ทับสะแก">ทับสะแก</option>
                                    <option value="เมือง​ประจวบ​">เมือง​ประจวบ​</option>
                                </select>
                            ...
                            <div class="mb-3">
                                <label for="destinationSearch" class="form-label">โน้ตกรณีลงที่อำเภออื่นกลางทาง</label>
                                <!-- Search Functionality -->
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                <div class="col-auto">
                                    <label for="seatInput" class="col-form-label">หมายเลขที่นั่ง</label>
                                </div>
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    ...
                                    เลือกที่นั่งจากแผนผังด้านบน
                                    </span>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="bookAmount" class="form-label">ราคา</label>
                                <input type="text" class="form-control" id="bookAmount" name="bookAmount" readonly>
                            </div>
                            <button type="submit" class="btn btn-success" name="submit">จองตั๋ว</button>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <!-- Add Anything -->
