        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">ไม่พบรถตู้ในระบบ!!</h1>
                        <p class="fw-light">กรุณาเพิ่มรถตู้ในระบบ!</p>
                        <hr>
            ...
            <section id="bus">
                ...
                <div id="bus-results">
                    <?php if($role == "admin"){ ?>
                    <div>
                        <button id="add-button" class="button btn-sm" type="button"data-bs-toggle="modal" data-bs-target="#addModal">เพิ่มรถตู้ <i class="fas fa-plus"></i></button>
                    </div>
                    <?php } ?>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">เพิ่มรถตู้</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="addBusForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                <label for="busnumber" class="form-label">หมายเลขรหัสรถตู้</label><br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    ที่คุณต้องการลบรายการรถตู้นี้? <strong>ขั้นตอนนี้ยังไม่เสร็จ</strong>
                </p>
                <!-- Needed to pass id -->
            ...
            <div class="modal-footer d-flex justify-content-center">
                ...
                <button type="submit" form="delete-form" name="delete" class="btn btn-danger">ลบ</button>
            </div>
            </div>
        </div>
    </div>
