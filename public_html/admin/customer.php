                ...
                */
                ...
                if(!$customer_exists)
                {
                    ...
                    if($autoInc_id)
                    {
                        ...
                        $query = "UPDATE `customers` SET `customer_id` = '$customer_id' WHERE `customers`.`ifgd` = $autoInc_id;";
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">ไม่พบลูกค้า!!</h1>
                        <p class="fw-light">กรุณาเพิ่มลูกค้าด้วยค่ะ!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">เพิ่ม <i class="fas fa-plus"></i></button> เพื่อเพิ่มลูกค้า!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="customer">
                ...
                <div id="customer-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">เพิ่มรายละเอียดลูกค้า <i class="fas fa-plus"></i></button>
                    </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addCustomerForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <button type="submit" class="btn btn-success" name="submit">ตกลง</button>
                        </form>
                    </div>
