                ...
                <div>
                    <div id="signupForm">
                        ...
                        <form action="../assets/partials/_handleSignup.php" method="POST">
                            ...
                            <div>
                                <input id="confPassword" type="password" name="confPassword" placeholder="ยืนยันรหัสผ่าน*" required>
                                <span id="confPassErr" class="error"></span>
                            </div>
                            <div>
                                <select name="role" class="form-control" placeholder="ชื่อผู้ใช้*" required>
                                    <option value="admin">ผู้ดูแล</option>    
                                    <option value="สมาชิก">สมาชิก</option>    

                                </select>
                            </div>
                            <button id="signup-btn" type="submit" name="signup" style='font-family:Kanit;'>ยืนยัน</button>
                        </form>
                    </div>
                </div>
                <div>
